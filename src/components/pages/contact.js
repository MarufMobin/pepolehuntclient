          ...
          <div className="col-md-4">
            <div className="padding40 box-rounded mb30">
              ...
              <address className="s1">
                <span>
                  <i className="id-color fa fa-map-marker fa-lg"></i>Zirabo,
                  Savar, DHaka
                </span>
                <span>
                  <i className="id-color fa fa-phone fa-lg"></i>+8801313885822
                </span>
                <span>
                  <i className="id-color fa fa-envelope-o fa-lg"></i>
                  <span className="btn">peoplehunt@example.com</span>
                </span>
                {/* <span><i className="id-color fa fa-file-pdf-o fa-lg"></i><span className='btn'></span></span> */}
              </address>
            </div>
            ...
            <div className="padding40 box-rounded mb30 text-light">
              ...
              <address className="s1">
                <span>
                  <i className="fa fa-map-marker fa-lg"></i>Zirabo, Savar, DHaka
                </span>
                <span>
                  <i className="fa fa-phone fa-lg"></i>+8801313885822
                </span>
                <span>
